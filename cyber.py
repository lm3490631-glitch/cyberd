...
BREACH_API_KEY = "b55396ee14mshe0b64759dd2acccp1a5624jsnb63a708254eb"  # مفتاحك السري الجديد جاهز ومفعل

# 1️⃣ دالة تحليل تفاصيل الرابط
            ...
            if re.match(r"[^@]+@[^@]+\.[^@]+", email_input):
                ...
                with st.spinner("جاري فحص وتتبع سجل الخروقات للبريد من الخوادم العالمية..."):
                    ...
                    if is_breached is None:
                        ...
                        st.error("🚨 تحذير أمني: تم العثور على هذا البريد في خروقات وتسريبات حقيقية!")
